...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  signUp() {
    if (_formKey.currentState!.validate()) {
      //context.read<SignUpProvider>().set_isloading(true);
      authMethods.SignUp_WithEmailPasword(email_TextEditingController!.text,
  ...
  Widget build(BuildContext context) {
    return
        ...
        Scaffold(
      body: SafeArea(
          child: false //context.watch<SignUpProvider>().isLoading
              ? Container(
                  child: Center(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              TextFormField(
                                validator: (val) {
                                  return password_TextEditingController!.text ==
                                          val
                                      ? null
